    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <LocalizedText as="h2" className="text-xl font-semibold text-gray-900 mb-2">
            {t('auth.accessDenied')}
          </LocalizedText>
          <LocalizedText className="text-gray-600 mb-4">
            {t('auth.roleRequired', `This feature requires ${requiredRole} role.`)}
          </LocalizedText>
      ...
      fallback || (
        <div className="min-h-screen flex items-center justify-center">
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <LocalizedText className="text-gray-600 mb-4">
              {t('auth.permissionRequired', `This feature requires '${requiredPermission}' permission.`)}
            </LocalizedText>
            <LocalizedText className="text-sm text-gray-500">
              {t('auth.currentRole', `Your current role: ${user?.role}`)}
            </LocalizedText>
