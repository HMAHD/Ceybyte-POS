        ...
        <div className='relative'>
          ...
          <div className='flex items-center justify-between mb-6'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                <Title level={3} className='mb-0 text-gray-800 leading-tight'>{APP_NAME}</Title>
                <Text type='secondary' className='text-xs'>Powered by {COMPANY_NAME}</Text>
              </div>
            </div>
          ...
          <div className='space-y-4'>
            ...
            <div className='backdrop-blur-sm bg-gray-50/80 rounded-xl p-1 border border-gray-200/50'>
              <Segmented
                ...
                options={[
                  {
                    label: <span className='text-gray-700 font-medium'><LocalizedText>{t('auth.password')}</LocalizedText></span>,
                    value: 'password',
                    icon: <LockOutlined className='text-gray-600' />,
                  },
                  {
                    label: <span className='text-gray-700 font-medium'><LocalizedText>{t('auth.pin')}</LocalizedText></span>,
                    value: 'pin',
            ...
            {loginMode === 'password' && (
              ...
              >
                <Form.Item
                  label={<span className='text-gray-700 text-sm font-medium'><LocalizedText>{t('auth.username')}</LocalizedText></span>}
                  name='username'
                  rules={[
                ...
                <Form.Item
                  label={<span className='text-gray-700 text-sm font-medium'><LocalizedText>{t('auth.password')}</LocalizedText></span>}
                  name='password'
                  rules={[
            ...
            {loginMode === 'pin' && (
              ...
              >
                ...
                <Form.Item
                  label={<span className='text-gray-700 text-sm font-medium'><LocalizedText>{t('auth.pin')}</LocalizedText></span>}
                  name='pin'
                  rules={[
            ...
            <div className='backdrop-blur-sm bg-gray-50/80 rounded-xl border border-gray-200/50 p-4'>
              ...
              <details className='mt-4'>
                ...
                <div className='mt-3 backdrop-blur-sm bg-white/60 rounded-lg p-3 text-xs space-y-2 text-gray-600 border border-gray-200/30'>
                  <div className='flex justify-between'><strong className='text-gray-700'>Admin:</strong> <span>admin/admin123 (PIN: 1234)</span></div>
                  <div className='flex justify-between'><strong className='text-gray-700'>Cashier:</strong> <span>cashier/cashier123 (PIN: 2345)</span></div>
                  <div className='flex justify-between'><strong className='text-gray-700'>Helper:</strong> <span>helper/helper123 (PIN: 3456)</span></div>
                </div>
              </details>
            </div>
          </div>
