...
import { Layout, Card, Button, Input, Space, Typography, Tag, Alert, Row, Col } from 'antd';
import { ShoppingCartOutlined, ScanOutlined, CreditCardOutlined, DollarOutlined, LogoutOutlined } from '@ant-design/icons';
        ...
        <div className="flex justify-between items-center h-full">
          <div className="flex items-center">
            <Title level={3} className="mb-0 mr-3">
              ...
              <LocalizedText>{t('pos.pointOfSale', 'Point of Sale')}</LocalizedText>
            </Title>
            <Tag color="blue">
            ...
            <Col xs={24} lg={8}>
              <Card
                title={
                  <Space>
                    <ScanOutlined />
                    <LocalizedText>{t('pos.productSearch', 'Product Search')}</LocalizedText>
                  </Space>
                }
                className="h-full"
              >
              ...
              <Card
                title={
                  <Space>
                    ...
                    <LocalizedText>{t('pos.cart', 'Shopping Cart')}</LocalizedText>
                  </Space>
                }
                className="h-full"
              >
                ...
                <div className="border-t pt-4 mt-4">
                  <div className="flex justify-between items-center">
                    <Title level={4} className="mb-0">
                      <LocalizedText>{t('common.total', 'Total')}</LocalizedText>
                    </Title>
                    <Title level={4} className="mb-0">
                      {formatCurrency(0)}
                    </Title>
          ...
          <Alert
            ...
            message={
              <Title level={4} className="mb-2">
                <LocalizedText>{t('auth.helperInstructions', 'Helper Mode Instructions')}</LocalizedText>
              </Title>
            }
            description={
